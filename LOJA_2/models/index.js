...
db.avaliacoes.hasMany(db.produtos);

db.produtos.belongsToMany(db.categorias, {through: "produto-categoria"});
db.categorias.belongsToMany(db.produtos, {through: "produto-categoria"});
